...
Future<List<dynamic>> fetchMostRentedCars() async {
  ...
  if (response.statusCode == 200) {
    ...
    print(
        'Failed to load most rented cars. Status code: ${response.statusCode}');
...
class _HomeState extends State<Home> {
      ...
      actions: <Widget>[
        PopupMenuButton<String>(
          itemBuilder: (context) => [
            ...
            const PopupMenuItem(
                child: Text('Return a Car'), value: 'Return Car'),
            const PopupMenuItem(child: Text('Dashboard'), value: 'Dashboard'),
          ],
  ...
  Widget buildMostRentedCarsContainer() {
    return Align(
      ...
      child: Container(
        margin:
            EdgeInsets.only(top: MediaQuery.of(context).size.height * 0.2 + 10),
